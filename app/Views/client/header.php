...
<head>
  ...
  <script src="/php2/ASMC/app/public/js/filter.js"></script>
  <script src="/php2/ASMC/app/public/js/openpopup.js"></script>
  <script src="/php2/ASMC/app/public/js/updateQuantity.js"></script>
  <script src="/php2/ASMC/app/public/js/resetpass.js"></script>
  <script src="/php2/ASMC/app/public/js/addTocard.js"></script>
          ...
          <ul class="navbar-nav">
            <?php foreach ($ParentsC as $category): ?>
              <li class="nav-item dropdown">
                <a href="/php2/ASMC/product/category/<?= $category['id'] ?>" class="nav-link me-2 fw-semibold"><?= $category['name'] ?></a>
                <?php if (isset($ChildrenC[$category['id']]) && !empty($ChildrenC[$category['id']])): ?>
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown<?= $category['id'] ?>">
                    <?php foreach ($ChildrenC[$category['id']] as $child): ?>
                      <li><a class="dropdown-item" href="/php2/ASMC/product/category/<?= $child['id'] ?>"><?= $child['name'] ?></a></li>
                    <?php endforeach; ?>
                  </ul>
                <?php endif; ?>
              </li>
