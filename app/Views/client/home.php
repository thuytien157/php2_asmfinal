<div class="container-xxl text-center">
    <div id="carouselExampleAutoplaying" class="carousel slide z-0" data-bs-ride="carousel" style="margin-top: 80px;">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="app/public/img/banner/mlb_desktop_en_be560d199f054efa9d99ae5826e2cdde.webp" class="d-block w-100 img-fluid" alt="...">
            </div>
            <div class="carousel-item">
                <img src="app/public/img/banner/msloyalty_mlb_web.webp" class="d-block w-100 img-fluid" alt="...">
            </div>
            <div class="carousel-item">
                <img src="app/public/img/banner/1960x640-mua-ngay.webp" class="d-block w-100 img-fluid" alt="...">
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-12 col-md-6">
                <div class="position-relative overflow-hidden">
                    <img src="app/public/img/banner/hangmoive_main.jpg" class="w-100 img-fluid" alt="">
            ...
            <div class="col-12 col-md-6">
                <div class="row g-2" id="sanpham_slice">
                    <?php foreach ($listpro_new as $product): ?>
                        <div class="col-12 col-sm-6 col-md-6">
                            <a href="/php2/ASMC/product/detail/<?= $product['id'] ?>" class="card text-decoration-none">
                                ...
                                <?php endif; ?>
                                <img src="app/public/img/products/<?= $product['image'] ?>" class="card-img-top small-img img-fluid <?= $product['status'] == 'inactive' ? 'opacity-50' : ''; ?>" alt="...">
    ...
    <div class="hangbanchay">
        <div class="row g-3" id="sanpham_slice1">
            <?php foreach ($listpro_sell as $product): ?>
        ...
        <div class="row g-3">
            <div class="col-12 col-md-6">
                <div class="row g-2" id="sanpham_slice2">
                    <?php foreach ($listpro_sale as $product): ?>
                        <div class="col-12 col-sm-6 col-md-6">
                            <a href="/php2/ASMC/product/detail/<?= $product['id'] ?>" class="card text-decoration-none">
                                <?php if (!empty($product['discount'])): ?>
                                    <div class="position-absolute top-0 start-0 badge text-bg-danger m-2"><?= $product['discount'] ?>%</div>
            ...
            <div class="col-12 col-md-6">
                <div class="position-relative overflow-hidden">
                    <img src="app/public/img/banner/bst_hip.jfif" class="w-100 img-fluid" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-dark bg-opacity-50 hover-overlay">
                        <a href="/php2/ASMC/product" type="button" class="btn btn-outline-light btn-sm">Xem tất cả</a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="app/public/img/articles/baiviet1.jfif" alt="Card image" style="width:100%">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="app/public/img/articles/baiviet2.jfif" alt="Card image" style="width:100%">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="app/public/img/articles/baiviet3.jfif" alt="Card image" style="width:100%">
                    <div class="card-img-overlay text-light w-100 mt-5">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="app/public/img/articles/baiviet4.jfif" alt="Card image" style="width:100%">
                    <div class="card-img-overlay text-light w-100 mt-5">
